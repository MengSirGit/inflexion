 ...
 * modeRightPos >= 12 时, 索引位置为高音区 commonModule['high'][modeRightPos  - 12]
 * modeRightPos < 0 时, 索引位置为低音区 commonModule['low'][commonModule['low'].length + modeRightPos]
 */
...
function inflexionAction(valF, valS, syllable, type) {
    ...
    let modePos = commonModule[type].indexOf(syllable)
